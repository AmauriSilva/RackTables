...
(
	...
	'jun13-get8021q-main'      => 'jun13Read8021QConfig',
	'jun13-xlatepushq-main'    => 'jun13TranslatePushQueue',
	'jun13-getallconf-main'    => 'jun13SpotConfigText',
	'jun13-getlldpstatus-main' => 'jun13ReadLLDPStatus',
	'jun13-getportstatus-main' => 'jun13ReadInterfaceStatus',
...
function queryTerminal ($object_id, $commands, $tolerate_remote_errors = TRUE)
{
	...
	{
		$ret_code = 0;
		$file = "/tmp/runConfig_" . $settings[hostname] . ".cfg";
	...
	elseif ($breed == 'xos12')
	{
		...
		exec("sudo -u racktables /usr/bin/ssh $host $commands", $out_a);
		$out = implode("\n", $out_a);
		#var_dump($out);
	}
	else
